...
<body bgcolor="white">
	...
	<div class="main">
		...
		<br><br>
		<div class="container">
		<center><b style="font-family:Georgia;font-size: 15px;">Афиша</b></center><br>
			<?php
				$inquery = "SELECT exhibition.*, images.image FROM exhibition INNER JOIN images ON (exhibition.id_img = images.id_img)";
				...
				<tr>
					<td rowspan="4" ><img src="img/<?php echo $result['image']?>.jpeg" width="550" height="380"></td>
					<th><?php echo $result['exhibition_name']?></th>
				</tr>
				<tr>
					<td><a href="tickets.php">Купить билет</a></td>
				</tr>
				<tr>
